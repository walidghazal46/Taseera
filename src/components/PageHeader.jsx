export default function PageHeader({ eyebrow, title, description, actions }) {
  return (
    <div className="rounded-[20px] border border-white/10 bg-[linear-gradient(180deg,#182e56_0%,#10213e_100%)] px-3 py-3 text-white shadow-[0_18px_36px_rgba(15,23,42,0.2)] sm:rounded-[24px] sm:px-4">
