        ...
        <div className="flex flex-1 flex-col overflow-hidden px-3 py-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
          <div className="flex flex-col justify-end gap-6 sm:justify-between h-full">
            <div className="pt-3 text-center">
              ...
              <p
                className={`mx-auto mt-2 max-w-[17.5rem] px-2 text-center text-[30px] font-medium leading-5 ${
            ...
            <div className="grid shrink-0 gap-2 pt-1.5 mb-[1cm] sm:mb-0">
              <div className="grid grid-cols-2 rounded-[14px] bg-[#f4ecdf] p-1">
                {[
                  ...
                  <button
                    ...
                    className={`rounded-[10px] px-2.5 py-2 text-[29px] font-bold transition ${
                      mode === item.id
              ...
              <div className="rounded-[18px] border border-[#eadfca] bg-white p-3 shadow-sm">
                {mode === "register" && (
                  <input
                    ...
                    className="w-full rounded-[12px] border border-slate-200 px-3 py-2.5 text-[30px] outline-none"
                ...
                <input
                  ...
                  className="mt-2 w-full rounded-[12px] border border-slate-200 px-3 py-2.5 text-[30px] outline-none"
                ...
                <button
                  ...
                  onClick={submit}
                  disabled={loading}
                  className="mt-3 w-full rounded-full bg-[linear-gradient(135deg,#0A4C87_0%,#002D5A_100%)] px-3 py-2.5 text-[30px] font-bold text-white disabled:opacity-60"
                >
                  {loading
                ...
                {error && (
                  <p className="mt-2 text-center text-[29px] font-semibold text-red-600">{error}</p>
                )}
                <p className="mt-2 text-center text-[27px] leading-5 text-slate-500">
                  {mode === "register"
              ...
              <button
                ...
                disabled={loading}
                className="flex w-full items-center justify-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-2.5 text-[30px] font-bold text-slate-700 shadow-sm disabled:opacity-60"
              >
              ...
              <button
                ...
                className="w-full rounded-full border border-[#d8b16c] bg-white px-3 py-2.5 text-[30px] font-bold text-[#b8893d]"
              >
                {text.login.guest}
              </button>

              <div className="rounded-[14px] bg-[#fff8ec] px-3 py-2 text-[29px] text-slate-600">
                <div className="mb-2 flex items-center justify-between gap-2">
                  <div className="flex items-center gap-1">
                    <button
                      type="button"
                      onClick={() => onChangeLanguage?.("ar")}
                      className={`rounded-[8px] px-2 py-1 text-[29px] font-bold ${
                        language === "ar"
